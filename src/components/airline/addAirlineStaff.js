...
class AddAirlineStaff extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      ...
      <Form.Row>
        ...
        >
          <Form.Label>Staff's First Name</Form.Label>
          <Form.Control
            type="text"
            name="firstName"
        ...
        <Form.Group
          ...
          className="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-4"
        >
          <Form.Label>Staff's Last Name</Form.Label>
          <Form.Control
            type="text"
            name="lastName"
        ...
        <Form.Group
          ...
          className="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-4"
        >
          <Form.Label>Staff's Phone Number</Form.Label>
          <PhoneInput
        ...
        <Form.Group
          ...
          className="col-12 col-xs-12 col-sm-12 col-md-6 col-lg-4"
        >
          <Form.Label>Staff's Email ID</Form.Label>
          <Form.Control
            type="Email"
            name="email"
...
export default AddAirlineStaff;
