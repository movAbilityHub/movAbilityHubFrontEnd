...
import AddAirlineStaff from "./addAirlineStaff";
      ...
      <div className="vh-100">
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="mr-auto">
              ...
              <Nav.Link
                className="active rounded"
                as={Link}
                to="/Airline/AdminDashboard/Staff"
              >
                Airline Staff Agents
              </Nav.Link>
            </Nav>
        ...
        <div className="wrapper">
          <Switch>
            <Route
              exact
              path="/Airline/AdminDashboard/"
              component={AddAirlineStaff}
            />
          </Switch>
        </div>
      </div>
